...
figure(2); clf; 
    ...
    ax(3) = subplot(413); plot(lightims(gIDX), fftamp(gIDX,2), '.-', 'MarkerSize', 8); ylim([200 700]);
...
figure(28); clf; plot(timtim(1:2:end), freeampdata(1:2:end), timtim(1:2:end), hdat(1:2:end)); ylim([-0.5 0.5]);

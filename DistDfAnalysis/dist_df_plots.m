...
[R,P,RL,RU] = corrcoef(dist_pair_cave(~isnan(df_pair_cave)), df_pair_cave(~isnan(df_pair_cave)))
[R,P,RL,RU] = corrcoef(dist_pair_srf(~isnan(df_pair_srf)), df_pair_srf(~isnan(df_pair_srf)))

function TGA_results = InteractionDelayReconstruction_calculate_custom(cfgTEP,cfgTESS,data)
...
if groupanalysis
    ...
    % set prediction time vectorTEpermtest
...
[dataprep, TGA_results] = TEfindDelay_custom(predicttimevec_u,cfgTESS,dataprep);
